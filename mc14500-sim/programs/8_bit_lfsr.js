...
export function init8BitLfsr(programSelector) {
    pgmInitCurrentProgram(programSelector, `8-bit LFSR`,
        `Set IN5 ON, IN6 OFF to load IN1-IN4 into RAM0-RAM3 <small>(initial condition x1..x4).</small><br/>
        Set IN5 OFF, IN6 OFF to load IN1-IN4 into RAM4-RAM7 <small>(initial condition x5..x8).</small><br/>
        Set IN6 ON to start generating pseudorandom sequence on output OUT0.<br/>
        OUT1 is the write signal. It switches from 0 to 1 when the OUT0 value is updated<br/>
