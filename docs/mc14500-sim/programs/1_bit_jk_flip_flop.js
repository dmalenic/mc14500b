...
export function initJkFlipFlop(programSelector) {
    pgmInitCurrentProgram(programSelector, `J-K Flip-Flop`,
        ...
        Latch input J is controlled by input 1.<br/>
        Latch input K is controlled by input 2.<br/>
        Latch input CLK is controlled by input 3.<br/>
        Latch output Q is displayed on output 0.`,
        rom, 0);
}
