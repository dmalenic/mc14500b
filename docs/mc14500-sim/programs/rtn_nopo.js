...
export function initRtnNopO(programSelector) {
    // noinspection SpellCheckingInspection
    pgmInitCurrentProgram(programSelector, `RTN Instruction Demo (NOPO as JSR)`,
        ...
        NOPO instruction is wired as JSR (jump to subroutine).`,
