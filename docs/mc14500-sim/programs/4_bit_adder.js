...
export function init4BitFullAdder(programSelector) {
    pgmInitCurrentProgram(programSelector, `4-bit Full-Adder with Carry`,
        ...
        Set inputs 5 to 1 and 6 to 0 to load inputs 1 to 4 into ram 0 to 3 <small>(the 2nd oper. B1-B3).</small><br/>
        Set inputs 5 and 6 to 0 to load inputs 1 to 4 <small>(the 1st operand A1-A4).</small><br/>
        Set input 6 to 1 to calculate R1-R4 and show the result on outputs 0 to 3, output 4<br/>
        shows the final Carry bit value.`,
        rom, 0);
}
