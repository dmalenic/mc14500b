; ------------------------------------------------------------
; RTN test program.
; This program illustrates how RTN and NOPF instructions can be used
...
; NOPF instruction is used to enable subroutines.
; ------------------------------------------------------------
; This program requires additional hardware to be wired to the MC14500 ICU.
; - The small ROM acting as a LUT. Its input is the MC14500 JMP and NOPF pins
...
NOPF    OUT0_ON_OUT1_OFF  ; jump to a subroutine that makes OUT0 on, OUT1 off
...
NOPF    OUT1_ON_OUT0_OFF  ; jump to a subroutine that makes OUT1 on, OUT0 off
