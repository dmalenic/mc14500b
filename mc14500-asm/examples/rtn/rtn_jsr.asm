...
; ------------------------------------------------------------
; This program demostrates how to use equals directive to define
; the pseudo instruction JSR and link it to the NOPO instruction to
; make the code more readable.
; ------------------------------------------------------------


; ------------------------------------------
; Alias NOPO to JSR for code readability
; ------------------------------------------
JSR     EQU     NOPO
...
JSR     OUT0_ON_OUT1_OFF  ; jump to a subroutine that makes OUT0 on, OUT1 off
...
JSR     OUT1_ON_OUT0_OFF  ; jump to a subroutine that makes OUT1 on, OUT0 off
