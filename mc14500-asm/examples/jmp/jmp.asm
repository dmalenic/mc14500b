; ------------------------------------------------------------
; JMP test program.
; This program illustrates how JMP instruction works.
...
; - The small ROM acting as a LUT. Its input is the MC14500 JMP pin as
;   well as io_address part of the instruction word from the progam ROM.
...
JMP     OUT0_ON_OUT1_OFF      ; jump to code that makes OUT0 on, OUT1 off
...
JMP     OUT1_ON_OUT0_OFF    ; jump to code that makes OUT1 on, OUT0 off
...
; ------------------------------------------
; Make OUT0 on, OUT1 off
; ------------------------------------------
OUT0_ON_OUT1_OFF:
ORC     RR          ; 1->RR
STO     OUT0        ; set OUT0
STOC    OUT1        ; clear OUT1
JMP     TEST_IN2    ; go to TEST_IN2

; ------------------------------------------
; Make OUT1 on, OUT0 off
; ------------------------------------------
OUT1_ON_OUT0_OFF:
ORC     RR          ; 1->RR
STOC    OUT0        ; clear OUT0
STO     OUT1        ; set OUT1
JMP     TEST_IN3    ; go to TEST_IN3
