...
#if SWITCH_TOGGLE
// IN0 is not used
// IN1..IN4 are configured to act as toggle switches,
// IN5..IN7 act as normal push buttons
const bool TOGGLE_IN1 = true;
const bool TOGGLE_IN2 = true;
const bool TOGGLE_IN3 = true;
const bool TOGGLE_IN4 = true;
const bool TOGGLE_IN5 = false;
const bool TOGGLE_IN6 = false;
const bool TOGGLE_IN7 = false;
#elif CONWAY_GOL
// IN0 and IN7 are not used.
// IN1..IN6 are configured to act as toggle swithces
const bool TOGGLE_IN1 = true;
const bool TOGGLE_IN2 = true;
const bool TOGGLE_IN3 = true;
const bool TOGGLE_IN4 = true;
const bool TOGGLE_IN5 = true;
const bool TOGGLE_IN6 = true;
const bool TOGGLE_IN7 = false;
#else
